...
const allClearBttn = document.querySelector('[data-allClear]');
...
numberBttns.forEach(Element => {
	Element.addEventListener('click', event => {
		calculator.appendNumber(Element.value);
...
clearBttn.addEventListener('click', button => {
	calculator.delete();
	calculator.updateDisplay();
});
